...
<script lang="ts" setup>
	...
	const Table = useTable({
		columns: [
			...
			{ label: t("型号"), prop: "model", minWidth: 120 },
			{ label: t("SN"), prop: "sn", minWidth: 120 },
			{ label: t("MAC"), prop: "mac", minWidth: 120 },
			{
				label: t("生产日期"),
				prop: "productionDate",
				minWidth: 140,
			...
			{ label: t("使用年限"), prop: "usageYears", minWidth: 120 },
			{
				label: t("状态"),
				prop: "status",
				minWidth: 120,
			...
			{ label: t("生产厂商"), prop: "manufacturer", minWidth: 120 },
